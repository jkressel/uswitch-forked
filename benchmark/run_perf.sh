...
for run in {1..5}; do ./test1-uswitch Free_Test_Data_1MB_JPG.jpg 1 1 10 >> t1-3-1.perf; done
for run in {1..5}; do ./test1-uswitch Free_Test_Data_1MB_JPG.jpg 1 1 20 >> t1-3-2.perf; done
for run in {1..5}; do ./test1-uswitch Free_Test_Data_1MB_JPG.jpg 1 1 30 >> t1-3-3.perf; done
for run in {1..5}; do ./test1-uswitch Free_Test_Data_1MB_JPG.jpg 1 1 40 >> t1-3-4.perf; done
for run in {1..5}; do ./test1-uswitch Free_Test_Data_1MB_JPG.jpg 1 1 50 >> t1-3-5.perf; done
for run in {1..5}; do ./test1-uswitch Free_Test_Data_1MB_JPG.jpg 1 1 60 >> t1-3-6.perf; done
for run in {1..5}; do ./test1-uswitch Free_Test_Data_1MB_JPG.jpg 1 1 70 >> t1-3-7.perf; done
for run in {1..5}; do ./test1-uswitch Free_Test_Data_1MB_JPG.jpg 1 1 80 >> t1-3-8.perf; done
for run in {1..5}; do ./test1-uswitch Free_Test_Data_1MB_JPG.jpg 1 1 90 >> t1-3-9.perf; done
for run in {1..5}; do ./test1-uswitch Free_Test_Data_1MB_JPG.jpg 1 1 100 >> t1-3-10.perf; done
...
for run in {1..5}; do ./test3-uswitch 1.gz 100 10 1 >> t2-1-1.perf; done
for run in {1..5}; do ./test3-uswitch 1.gz 100 20 1 >> t2-1-2.perf; done
for run in {1..5}; do ./test3-uswitch 1.gz 100 30 1 >> t2-1-3.perf; done
for run in {1..5}; do ./test3-uswitch 1.gz 100 40 1 >> t2-1-4.perf; done
for run in {1..5}; do ./test3-uswitch 1.gz 100 50 1 >> t2-1-5.perf; done
for run in {1..5}; do ./test3-uswitch 1.gz 100 60 1 >> t2-1-6.perf; done
for run in {1..5}; do ./test3-uswitch 1.gz 100 70 1 >> t2-1-7.perf; done
for run in {1..5}; do ./test3-uswitch 1.gz 100 80 1 >> t2-1-8.perf; done
for run in {1..5}; do ./test3-uswitch 1.gz 100 90 1 >> t2-1-9.perf; done
for run in {1..5}; do ./test3-uswitch 1.gz 100 100 1 >> t2-1-10.perf; done

for run in {1..5}; do ./test3-uswitch 2.gz 100 10 1 >> t2-2-1.perf; done
for run in {1..5}; do ./test3-uswitch 2.gz 100 20 1 >> t2-2-2.perf; done
for run in {1..5}; do ./test3-uswitch 2.gz 100 30 1 >> t2-2-3.perf; done
for run in {1..5}; do ./test3-uswitch 2.gz 100 40 1 >> t2-2-4.perf; done
for run in {1..5}; do ./test3-uswitch 2.gz 100 50 1 >> t2-2-5.perf; done
for run in {1..5}; do ./test3-uswitch 2.gz 100 60 1 >> t2-2-6.perf; done
for run in {1..5}; do ./test3-uswitch 2.gz 100 70 1 >> t2-2-7.perf; done
for run in {1..5}; do ./test3-uswitch 2.gz 100 80 1 >> t2-2-8.perf; done
for run in {1..5}; do ./test3-uswitch 2.gz 100 90 1 >> t2-2-9.perf; done
for run in {1..5}; do ./test3-uswitch 2.gz 100 100 1 >> t2-2-10.perf; done

for run in {1..5}; do ./test3-uswitch 3.gz 100 10 1 >> t2-3-1.perf; done
for run in {1..5}; do ./test3-uswitch 3.gz 100 20 1 >> t2-3-2.perf; done
for run in {1..5}; do ./test3-uswitch 3.gz 100 30 1 >> t2-3-3.perf; done
for run in {1..5}; do ./test3-uswitch 3.gz 100 40 1 >> t2-3-4.perf; done
for run in {1..5}; do ./test3-uswitch 3.gz 100 50 1 >> t2-3-5.perf; done
for run in {1..5}; do ./test3-uswitch 3.gz 100 60 1 >> t2-3-6.perf; done
for run in {1..5}; do ./test3-uswitch 3.gz 100 70 1 >> t2-3-7.perf; done
for run in {1..5}; do ./test3-uswitch 3.gz 100 80 1 >> t2-3-8.perf; done
for run in {1..5}; do ./test3-uswitch 3.gz 100 90 1 >> t2-3-9.perf; done
for run in {1..5}; do ./test3-uswitch 3.gz 100 100 1 >> t2-3-10.perf; done

for run in {1..5}; do ./test3-uswitch j1.jpeg.gz 100 10 1 >> t2-4-1.perf; done
for run in {1..5}; do ./test3-uswitch j1.jpeg.gz 100 20 1 >> t2-4-2.perf; done
for run in {1..5}; do ./test3-uswitch j1.jpeg.gz 100 30 1 >> t2-4-3.perf; done
for run in {1..5}; do ./test3-uswitch j1.jpeg.gz 100 40 1 >> t2-4-4.perf; done
for run in {1..5}; do ./test3-uswitch j1.jpeg.gz 100 50 1 >> t2-4-5.perf; done
for run in {1..5}; do ./test3-uswitch j1.jpeg.gz 100 60 1 >> t2-4-6.perf; done
for run in {1..5}; do ./test3-uswitch j1.jpeg.gz 100 70 1 >> t2-4-7.perf; done
for run in {1..5}; do ./test3-uswitch j1.jpeg.gz 100 80 1 >> t2-4-8.perf; done
for run in {1..5}; do ./test3-uswitch j1.jpeg.gz 100 90 1 >> t2-4-9.perf; done
for run in {1..5}; do ./test3-uswitch j1.jpeg.gz 100 100 1 >> t2-4-10.perf; done
