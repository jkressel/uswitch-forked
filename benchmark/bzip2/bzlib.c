...
//__attribute__((weak)) int call_decompress(DState* s) {
//	printf("blaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\n");
//	return 0;
//}
/*---------------------------------------------------*/
#ifndef BZ_NO_STDIO
...
int BZ_API(BZ2_bzDecompress) ( bz_stream *strm )
{
   ...
   while (True) {
	 ...
	 Int32 r = call_decompress(s);
	 fprintf(stderr, "Back in regular lib\n");
         if (r == BZ_STREAM_END) {
            if (s->verbosity >= 3)
