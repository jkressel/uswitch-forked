...
for run in {1..5}; do ./memex 10000 1 >> memexdir/10000-1.perf & ../../wss/wss.pl $! 2 >> memexdir/10000-1.mem && pkill memex; done
for run in {1..5}; do ./memex 100000 1 >> memexdir/100000-1.perf & ../../wss/wss.pl $! 2 >> memexdir/100000-1.mem && pkill memex; done
...
for run in {1..5}; do ./memex 10000 2 >> memexdir/10000-2.perf & ../../wss/wss.pl $! 2 >> memexdir/10000-2.mem && pkill memex; done
for run in {1..5}; do ./memex 100000 2 >> memexdir/100000-2.perf & ../../wss/wss.pl $! 2 >> memexdir/100000-2.mem && pkill memex; done
...
for run in {1..5}; do ./memex 10000 3 >> memexdir/10000-3.perf & ../../wss/wss.pl $! 2 >> memexdir/10000-3.mem && pkill memex; done
for run in {1..5}; do ./memex 100000 3 >> memexdir/100000-3.perf & ../../wss/wss.pl $! 2 >> memexdir/100000-3.mem && pkill memex; done
...
for run in {1..5}; do ./memex 10000 4 >> memexdir/10000-4.perf & ../../wss/wss.pl $! 2 >> memexdir/10000-4.mem && pkill memex; done
for run in {1..5}; do ./memex 100000 4 >> memexdir/100000-4.perf & ../../wss/wss.pl $! 2 >> memexdir/100000-4.mem && pkill memex; done
...
for run in {1..5}; do ./memex 10000 5 >> memexdir/10000-5.perf & ../../wss/wss.pl $! 2 >> memexdir/10000-5.mem && pkill memex; done
for run in {1..5}; do ./memex 100000 5 >> memexdir/100000-5.perf & ../../wss/wss.pl $! 2 >> memexdir/100000-5.mem && pkill memex; done
...
for run in {1..5}; do ./memex 10000 6 >> memexdir/10000-6.perf & ../../wss/wss.pl $! 2 >> memexdir/10000-6.mem && pkill memex; done
for run in {1..5}; do ./memex 100000 6 >> memexdir/100000-6.perf & ../../wss/wss.pl $! 2 >> memexdir/100000-6.mem && pkill memex; done
...
for run in {1..5}; do ./memex 10000 7 >> memexdir/10000-7.perf & ../../wss/wss.pl $! 2 >> memexdir/10000-7.mem && pkill memex; done
for run in {1..5}; do ./memex 100000 7 >> memexdir/100000-7.perf & ../../wss/wss.pl $! 2 >> memexdir/100000-7.mem && pkill memex; done
...
for run in {1..5}; do ./memex 10000 8 >> memexdir/10000-8.perf & ../../wss/wss.pl $! 2 >> memexdir/10000-8.mem && pkill memex; done
for run in {1..5}; do ./memex 100000 8 >> memexdir/100000-8.perf & ../../wss/wss.pl $! 2 >> memexdir/100000-8.mem && pkill memex; done
...
for run in {1..5}; do ./memex 10000 9 >> memexdir/10000-9.perf & ../../wss/wss.pl $! 2 >> memexdir/10000-9.mem && pkill memex; done
for run in {1..5}; do ./memex 100000 9 >> memexdir/100000-9.perf & ../../wss/wss.pl $! 2 >> memexdir/100000-9.mem && pkill memex; done
...
for run in {1..5}; do ./memex 10000 10 >> memexdir/10000-10.perf & ../../wss/wss.pl $! 2 >> memexdir/10000-10.mem && pkill memex; done
for run in {1..5}; do ./memex 100000 10 >> memexdir/100000-10.perf & ../../wss/wss.pl $! 2 >> memexdir/100000-10.mem && pkill memex; done
